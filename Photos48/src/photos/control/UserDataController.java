...
public class UserDataController implements Serializable
{
	...
	private UserDataController()
	{
    	...
    	Photo p1 = new Photo("season1", "data/stockimage1.jpeg", LocalDateTime.now().format(DateTimeFormatter.ofPattern("MM/dd/yyyy hh:mm a")));
    	Photo p2 = new Photo("season2", "data/stockimage2.jpeg", LocalDateTime.now().format(DateTimeFormatter.ofPattern("MM/dd/yyyy hh:mm a")));
    	Photo p3 = new Photo("season3", "data/stockimage3.jpeg", LocalDateTime.now().format(DateTimeFormatter.ofPattern("MM/dd/yyyy hh:mm a")));
    	Photo p4 = new Photo("season4", "data/stockimage4.jpeg", LocalDateTime.now().format(DateTimeFormatter.ofPattern("MM/dd/yyyy hh:mm a")));
    	Photo p5 = new Photo("season5", "data/stockimage5.jpeg", LocalDateTime.now().format(DateTimeFormatter.ofPattern("MM/dd/yyyy hh:mm a")));
